...
public:
	...
	edge_bounds set_edges(const std::vector<Path> &polygons, int32_t x, int32_t y, int32_t scale);
	Canvas *fpoly(const std::vector<Path> &polygons, int32_t x, int32_t y, int winding);
